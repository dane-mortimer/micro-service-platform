    ...
    constructor(scope: Construct, id: string, props: EcsFargateServiceProps) {
        ...
        if (props.loadBalancerSettings) {
            ...
            loadBalancerSecurityGroup.addIngressRule(
                props.loadBalancerSettings.ingressRule.peer,
                props.loadBalancerSettings.ingressRule.port,
            );
        }
    }

    dependentServiceEnvironmentBuilder(
        dependentServices: IDependentService[] | undefined,
        namespace: string,
    ): { [key: string]: string } {
